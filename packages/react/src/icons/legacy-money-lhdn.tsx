 ...
 * MoneyLHDN Icon
 * @param className
 * @returns MoneyLHDNIcon
 */
export const MoneyLHDNIcon: FunctionComponent<SVGProps<SVGSVGElement>> = (
  props,
) => {
  return (
    <svg
      ...
      {...props}
    >
      <g id="agency-icon/money-lhdn" clipPath="url(#clip0_14237_1234)">
