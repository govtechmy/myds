 ...
 * RibbonNTRC Icon
 * @param className
 * @returns RibbonNTRCIcon
 */
export const RibbonNTRCIcon: FunctionComponent<SVGProps<SVGSVGElement>> = (
  props,
) => {
  return (
    <svg
