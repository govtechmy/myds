 ...
 */
export const DocumentMOFIcon: FunctionComponent<SVGProps<SVGSVGElement>> = (
  props,
) => {
  return (
    <svg
      ...
      <g id="agency-icon/document-mof" clipPath="url(#clip0_14237_1240)">
        <g id="agency-icons/mini/document-mof">
          <g id="Group 46">
            ...
            <path
              id="Vector 107"
              d="M9 9V22C9 23.6569 10.3431 25 12 25H21"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
