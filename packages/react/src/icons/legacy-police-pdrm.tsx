 ...
 * PolicePDRM Icon
 * @param className
 * @returns PolicePDRMIcon
 */
export const PolicePDRMIcon: FunctionComponent<SVGProps<SVGSVGElement>> = (
  props,
) => {
  return (
    <svg
      ...
      {...props}
    >
      <g id="agency-icon/police-pdrm" clipPath="url(#clip0_14237_1238)">
