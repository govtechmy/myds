...
Houses all the constituent components of the cookie banners. The component is a _controlled_ component. It is being built on `Dialog.Root` and `DialogBody`.
...
<TypeTable
  type={{
    showWhen: {
      description:
        "The visibility of the component depends on the value of 'showPreferences' props.",
      type: "enum",
