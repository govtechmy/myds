...
<TypeTable
  type={{
    onClick: {
      description:
        "Handler called when the close button is clicked to control the banner's visibility.",
      type: "function",
...
<TypeTable
  type={{
    fillWidth: {
      description:
        "When true, makes all direct children take up equal width and centers their content.",
      type: "boolean",
      typeDescription: "true | false",
      default: "false",
    },
...
<TypeTable
  type={{
    asChild: {
      description:
        "Renders the child element instead of the default button element, while preserving the component's props and functionality.",
      type: "boolean",
      typeDescription: "true | false",
      default: "false",
    },
