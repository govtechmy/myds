---
title: Date field
description: Allows users to input a date in a structured format
---

The date field is structured in clear format using separate fields for day, month, and year.
