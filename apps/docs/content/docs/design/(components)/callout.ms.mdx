---
title: Callout
description: Komponen Callout memberitahu pengguna tentang maklumat penting berkaitan tindakan mereka dalam Borang. Callout boleh menunjukkan kejayaan, amaran, kesilapan, atau menyediakan maklumat tambahan bergantung pada konteks dalam borang.
---

![callout-anatomy.png](/design/callout-anatomy.png)
...
![callout-type.png](/design/callout-type.png)
...
![callout-close-icon.png](/design/callout-close-icon.png)
...
![callout-buttons.png](/design/callout-buttons.png)
...
![callout-usage.png](/design/callout-usage.png)
...
![call-usage-2.png](/design/callout-usage-2.png)
