---
title: File upload
description: Allows users to upload and preview files
---

import { s3 } from "@/lib/constant";

It features a title, upload guidelines, an upload button, and a list displaying the uploaded items, with built-in error handling for file uploads.
...
1. **Disabled:** The item is not interactive, typically when the file cannot be removed or edited.
2. **Loading:** When the file is in the process of being uploaded.
