...
description: Notifies user that cookies are used to improve their browsing experience
---

import { s3 } from "@/lib/constant";

The cookies banner is often equipped with the option to manage consent preferences, for a variety of use case. It typically appears when a user lands on the website for the first time.
