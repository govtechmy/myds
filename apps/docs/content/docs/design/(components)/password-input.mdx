...
description: An input that securely masks user-entered passwords, ensuring privacy
---

It typically includes an option to toggle password visibility.
...
![password-input-size@1.5x.png](/design/password-input-size@1.5x.png)
