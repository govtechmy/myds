---
title: Toast
description: Provide feedback or alert the user of an event
---

import { s3 } from "@/lib/constant";

Toast is a small, non-intrusive notification that appears temporarily on the screen to provide feedback or alert the user of an event.
