---
title: Select
description: Allow user to choose from a list of options
---

import { s3 } from "@/lib/constant";

The component often appears as a popup menu where user clicks on the select button, to make a list of options appear.
...
2a. Show overlapped “Clear” button at the bottom of the multi-select type context menu when at

least ONE option is selected. If none is selected, hide it.

1. With search function at the bottom.
