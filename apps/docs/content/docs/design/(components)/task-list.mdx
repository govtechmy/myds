---
title: Task list
description: Allows to feed information or call to action in a structured way
---

The task list component shows all user tasks, making it easy to distinguish between completed and pending items.
