export default {
  metadata: {
    title: "MYDS - Malaysia Government Design System",
    description:
    ...
    openGraph: {
      ...
      images: {
        "1": {
          url: "https://cdn.jsdelivr.net/gh/govtechmy/myds@0.0.3/public/og/images/en-MY.png",
          alt: "Malaysia Government Design System",
        },
      },
    },
  },
  ...
  Home: {
    title: {
      hero: "Malaysia Government Design System (MYDS)",
      about: "What is a Design System?",
    ...
    about: {
      items: {
        "1": {
          title: "Beautiful Government Sites",
          description:
            "Clean and minimalist, ensuring that information is easy to find, and services are easy to use.",
        },
        "2": {
        ...
        "5": {
          ...
          description:
            "Out-of-the-box adherence to WCAG and best accessibility practices.",
        },
        "6": {
    ...
    previewContent: {
      items: {
        "1": {
          tag: "Beautiful Government Sites",
          title: "Government sites will look clean & well-designed",
          description:
            "A Design System ensures that all government websites maintain a consistent, clean, and well-designed appearance, enhancing usability, accessibility, and the overall digital presence of Malaysia's government services.",
        },
        "2": {
          tag: "Rapid Development",
          title: "Pre-built components let you focus on the product",
          description:
            "Simplifying development with ready-made components allows more focus on enhancing core features.",
        },
        "3": {
          tag: "Cost Savings",
          title: "Fewer tax ringgits will be spent on government sites",
          description:
            "Frontend development for government products will be much faster and cheaper, which saves taxpayer money.",
        },
      },
    },
    timeline: {
      ...
      items: {
        ...
        "5": {
          ...
          description:
            "Preview and testing with members of the local tech community and industry, as well as other public sector officers.",
          type: "none",
          year: "2025",
        },
        "6": {
          ...
          description:
            "Production-ready design system now ready to be used for any future product. A new era for gov.my sites begins!",
          type: "none",
          year: "2025",
        },
      },
  ...
  Masthead: {
    official_gov_website: "Official Malaysia Government Website",
    how_to_identify: "Here's how you know",
    official: "Official government websites end with .gov.my",
  ...
  Footer: {
    ...
    address:
      "Aras 13, 14 dan 15, Blok Menara, Menara Usahawan\nNo. 18, Persiaran Perdana, Presint 2\nPusat Pentadbiran Kerajaan Persekutuan\n62000 Putrajaya, Malaysia.",
  },
  Disclaimer: {
    header: "Disclaimer",
    desc: "The Ministry of Digital is not responsible for any loss or damage incurred from using the information on this portal.",
  },
  Privacy: {
    header: "Privacy Policy",
    your_privacy: "Your Privacy",
    your_privacy_desc:
      "This page explains the privacy policy that encompasses the use and protection of information submitted by visitors. If you make a transaction or send an email containing personal information, this information may be shared with other public agencies to assist in providing more effective and efficient services, for example in resolving complaints that require feedback from other agencies.",
    collected_info: "Information Collected",
    collected_info_desc:
      "No personal information will be collected while you are browsing this portal except for information submitted by you via email.\n\nWhat happens if I link to other portals/websites?\n\nThis portal contains links to other portals/websites. This privacy policy applies only to this website. It should be noted that the portals/websites linked may have different privacy policies, and visitors are advised to review and understand the privacy policies for each portal/website they visit.",
    policy_change: "Policy Change",
    policy_change_desc:
      "If this privacy policy is amended, the amendments will be updated on this page. By frequently browsing this page, you will be updated on the information collected, how it is used, and under certain conditions, how the information is shared with other parties.",
    personal_data: "Personal Data Protection",
    personal_data_act: "Personal Data Protection Act",
