...
import { Label } from "@myds/react/label";
 ...
 * ### Overview
 *
 * The Label component from @myds/react/label is a customizable UI element used to associate text with form controls like checkboxes and toggles. It accepts props such as htmlFor to link it to a specific form element and size to adjust its appearance. This component ensures accessibility and consistent styling across the application.
 *
 *
